...
namespace Negocio
{
    public class ManejadorUsuarios : IManejadorUsuarios
    {
        ...
        {
            Usuario viejoUsuario = _context.Usuario().ObtenerUno(id);
        ...
        {
            Usuario encontrado = _context.Usuario().ObtenerTodo().FirstOrDefault(u => u.Username == personaUsuario.Username);
